...
public class DemoActivity extends TabActivity implements View.OnClickListener{
	...
	BadgeView badge7;
	BadgeView badge8;
	FlagView.sample.BadgeView  badgeView;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		FlagView.sample.BadgeView badge = new FlagView.sample.BadgeView(this, target);
		badge.setText("1");
		badge.show();

        // *** set position ***

        btnPosition = (TextView) findViewById(R.id.position_target);
    	...
    	btnColour = (TextView) findViewById(R.id.colour_target);
    	...
    	btnAnim1 = (TextView) findViewById(R.id.anim1_target);
    	...
    	btnAnim2 = (TextView) findViewById(R.id.anim2_target);
        ...
        btnCustom = (TextView) findViewById(R.id.custom_target);
    	...
    	btnClick = (TextView) findViewById(R.id.click_target);
        ...
        btnTab = (TextView) findViewById(R.id.tab_btn);
        ...
        btnIncrement = (TextView) findViewById(R.id.increment_target);
	...
	protected void onResume() {
		...
		badgeView = (FlagView.sample.BadgeView) findViewById(R.id.main_dfv);
		badgeView.setOnDraggableFlagViewListener(new FlagView.sample.BadgeView.OnDraggableFlagViewListener() {
			@Override
			public void onFlagDismiss(FlagView.sample.BadgeView view) {
				Toast.makeText(DemoActivity.this, "on Flag Dismiss", Toast.LENGTH_SHORT).show();
