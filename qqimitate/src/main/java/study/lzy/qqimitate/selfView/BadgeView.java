...
public class BadgeView extends TextView {
    ...
    private boolean littlePoint=false;
...
//        setPadding(0, 0, 0, 0);
    ...
    public void setLittlePoint(){
            ...
            setHeight(dipToPixels(2 * DEFAULT_LR_PADDING_DIP));
            setWidth(dipToPixels(2 * DEFAULT_LR_PADDING_DIP));
            setPadding(0, 0, 0, 0);
            this.littlePoint = true;

//            params.height=(dipToPixels(2*DEFAULT_LR_PADDING_DIP));
//            params.width=(dipToPixels(2*DEFAULT_LR_PADDING_DIP));
    }

    public boolean isLittlePoint() {
        return littlePoint;
    }

    public BadgeView getNewView(){
        ViewGroup parent = (ViewGroup) getParent();
        parent.removeView(this);
        BadgeView badgeView=new BadgeView(context);
        badgeView.badgePosition=badgePosition;
        badgeView.badgeMarginH=badgeMarginH;
        badgeView.badgeMarginV=badgeMarginV;
        badgeView.badgeColor=badgeColor;
        badgeView.isShown=isShown;
        badgeView.badgeBg=badgeBg;
        badgeView.targetTabIndex=targetTabIndex;
        badgeView.setLayoutParams(getLayoutParams());
        badgeView.setPadding(badgeView.badgeMarginH, 0,badgeView.badgeMarginV, 0);

        parent.addView(badgeView);
        return badgeView;
    }
}
