...
public class RecordInfo extends BaseInfo{
    ...
    public RecordInfo( int userId, int userId2, String message,String time) {
    ...
    protected String getCreateSql() {
        return " , UserId  integer NOT NULL,UserId2 integer NOT NULL,message varchar(20),time varchar(20) ";
    }
    ...
    public static Cursor SELECT(int id, SQLiteDatabase db){
        String sql = "SELECT * FROM ChatRecord where UserId=? OR UserId2=?";
