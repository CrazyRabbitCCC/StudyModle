...
public class AnimationUtils {
    ...
    public void addAnimRightTOLeft(){
        addObjAnim(PropertyValuesHolder.ofFloat("translationX",0,-view.getWidth()));
    }
    public void addAnimLeftTORight(){
        addObjAnim(PropertyValuesHolder.ofFloat("translationX",-view.getWidth(),0));
    }
