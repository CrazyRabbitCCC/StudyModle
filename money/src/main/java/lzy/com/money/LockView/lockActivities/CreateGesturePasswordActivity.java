...
import lzy.com.money.Activity.LoginActivity;
import lzy.com.money.Application.moneyApplication;
import lzy.com.money.LockView.LockPatternView.DisplayMode;

import lzy.com.money.LockView.LockPatternUtils;
import lzy.com.money.LockView.LockPatternView;
...
public class CreateGesturePasswordActivity extends AppCompatActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		App= (moneyApplication) getApplication();
		App.getLockPatternUtils().clearLock();
		setContentView(R.layout.gesturepassword_create);
		if (App.getSystemConfig(5)){
	...
	private void saveChosenPatternAndFinish() {
		...
		if (App.getLockPatternUtils().saveLockPattern(mChosenPattern)) {
			App.setSystemConfig(3, true);
			App.setSystemConfig("3","2");
		}
		showToast("密码设置成功");
